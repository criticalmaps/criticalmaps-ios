...
//
//    var service: APIService = .noop
//    service.getRiders = { throw testError }
//    service.getChatMessages = { throw testError }
//
...
//    store.dependencies.apiService = service
...
//
//    var service: APIService = .noop
//    let chatResponse: [ChatMessage] = .make()
//    service.getChatMessages = { chatResponse }
//    let ridersResponse: [Rider] = .make()
//    service.getRiders = { ridersResponse }
//
//    var userDefaultsClient = UserDefaultsClient.noop
...
//    await store.receive(.fetchLocationsResponse(.success(ridersResponse))) {
//      $0.riderLocations = .success(ridersResponse)
//      $0.mapFeatureState.riderLocations = ridersResponse
...
//    await store.receive(.fetchChatMessages)
//    await store.receive(.fetchChatMessagesResponse(.success(chatResponse)))
//
...
//
//    await store.receive(.fetchDataResponse(.success(chatResponse)))
...
//
//    var service: APIService = .noop
//    service.getRiders = { serviceResponse }
//
//    var userDefaultsClient = UserDefaultsClient.noop
//    userDefaultsClient.boolForKey = { _ in true }
//
...
//    let response2 = [
//      ChatMessage(identifier: "NEWID", device: "Device", message: "Hi", timestamp: date().timeIntervalSince1970 + 15)
//    ]
