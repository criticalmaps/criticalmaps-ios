...
public class Logger {
    public static func log(_ type: OSLogType, log: OSLog, _ message: StaticString) {
    ...
    public static func log(_ type: OSLogType, log: OSLog, _ message: StaticString, parameter: String) {
        if #available(iOS 12.0, macOS 10.14, *) {
